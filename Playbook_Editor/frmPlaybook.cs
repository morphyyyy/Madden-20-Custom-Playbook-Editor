...
namespace Playbook_Editor
{
    public partial class frmPlaybook : Form
    {
        ...
        public void UpdatePlay(PLAY play)
        {
            ...
            dgvPLYS.Columns["PLYL"].Visible = false;
        ...
        {
            lblOpenPlaybook.ForeColor = Color.FromArgb(255, 252, 91, 11);
            lblOpenPlaybook.OutlineForeColor = Color.FromArgb(255, 255, 255, 255);
        }

        private void lblOpenPlaybook_MouseLeave(object sender, EventArgs e)
        {
            lblOpenPlaybook.ForeColor = Color.FromArgb(255, 255, 255, 255);
            lblOpenPlaybook.OutlineForeColor = Color.FromArgb(255, 252, 91, 11);
        }
        ...
        private void cmsEditPSAL_Copy_Click(object sender, EventArgs e)
        {
            ...
            string PLYS_Format = "Playbook_Editor.<List>PLYS";
            Clipboard.Clear();
            Clipboard.SetData(PLYS_Format, PLYS_Copy);
        }

        private void cmsEditPSAL_Paste_Click(object sender, EventArgs e)
        {
            var d = Clipboard.GetDataObject();
            if (Clipboard.ContainsData("Playbook_Editor.<List>PLYS"))
            {
                PlayCopy.PLYS = (List<PLYS>)Clipboard.GetData("Playbook_Editor.<List>PLYS");
            }
        ...
        private void cmsEditPSAL_Opened(object sender, EventArgs e)
        {
            if (Clipboard.ContainsData("Playbook_Editor.<List>PLYS"))
            {
